...
def music():
    os.system('python songs_2.py')

def movies():
    os.system('python movie_2.py')

def foods(): 
    os.system('python food_2.py')
def hello1():
...
canvas.pack()
gif1 = tkinter.PhotoImage(file='light-yellow-wallpapers-bright-yellow-wallpaper-light-yellow-background-hd-images-cute-light-yellow-wallpapers (1).png')
w = gif1.width()
h = gif1.height()
