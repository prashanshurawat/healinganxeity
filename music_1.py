...
def song2():
    webbrowser.open_new_tab('https://www.youtube.com/watch?v=DmsOinqrPvQ')

def song3():
    webbrowser.open_new_tab('https://www.youtube.com/watch?v=bmyv0nRkDmc')

def song4():
    webbrowser.open_new_tab('https://www.youtube.com/watch?v=cprez2G15LI')

def song5():
    webbrowser.open_new_tab('https://www.youtube.com/watch?v=U-ty-2B02VY')

def song6():
    webbrowser.open_new_tab('https://www.youtube.com/watch?v=E8rpY2FwKkY')

def song7():
    webbrowser.open_new_tab('https://www.youtube.com/watch?v=2QOYVEgfYX4')

def song8():
    webbrowser.open_new_tab('https://www.youtube.com/watch?v=pUUGJD-JjGA')

def song9():
    webbrowser.open_new_tab('https://www.youtube.com/watch?v=RBumgq5yVrA')

def song10():
    webbrowser.open_new_tab('https://www.youtube.com/watch?v=8xg3vE8Ie_E')

def song11():
    webbrowser.open_new_tab('https://www.youtube.com/watch?v=VuNIsY6JdUw')

def song12():
    webbrowser.open_new_tab('https://www.youtube.com/watch?v=kXYiU_JCYtU')

def song13():
    webbrowser.open_new_tab('https://www.youtube.com/watch?v=hT_nvWreIhg')

def song14():
    webbrowser.open_new_tab('https://www.youtube.com/watch?v=lEi_XBg2Fpk')
